package com.myself.mall.search;

import com.alibaba.fastjson.JSON;
//import com.myself.mall.search.bean.Account;
//import com.myself.mall.search.bean.User;
//import com.myself.mall.search.config.MallElasticSearchConfig;
...
//
//        // 2.执行检索
//        SearchResponse search = client.search(searchRequest, MallSearchConfig.COMMON_OPTIONS);
//
//        // 3.分析结果
...
//		request.source("userName","firenay","age","20","gender","男");
        ...
        // 执行保存操作
        IndexResponse response = client.index(request, MallSearchConfig.COMMON_OPTIONS);
